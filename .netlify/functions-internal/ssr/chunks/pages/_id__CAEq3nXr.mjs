/* empty css                          */
import 'cssesc';
import { c as createAstro, d as createComponent, r as renderTemplate, m as maybeRenderHead, e as addAttribute, f as renderSlot, g as renderComponent, h as renderHead, i as renderTransition } from '../astro_DFC_LFQJ.mjs';
import cn from 'clsx';
...
}, "C:/Users/PC/Desktop/MyCodes/Astro/Spotify-Clone/src/icons/Library.astro", void 0);
...
}, "C:/Users/PC/Desktop/MyCodes/Astro/Spotify-Clone/src/icons/Home.astro", void 0);
...
}, "C:/Users/PC/Desktop/MyCodes/Astro/Spotify-Clone/src/icons/Search.astro", void 0);
...
}, "C:/Users/PC/Desktop/MyCodes/Astro/Spotify-Clone/src/components/SideMenuItem.astro", void 0);
...
const $$SideMenuCard = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<a${addAttribute(`/playlist/${id}`, "href")} class="playlist-item flex relative p-2 overflow-hidden items-center gap-5 rounded-md hover:bg-zinc-800"> <picture class="h-12 w-12 flex-none"> <img${addAttribute(cover, "src")}${addAttribute(`Cover of the playlist ${title} by ${artistsString}`, "alt")} class="object-cover w-full h-full rounded-md"> </picture> <div class="flex flex-auto flex-col truncate"> <h4 class="text-white text-sm"> ${title} </h4> <span class="text-xs text-gray-400"> ${artistsString} </span> </div> </a>`;
}, "C:/Users/PC/Desktop/MyCodes/Astro/Spotify-Clone/src/components/SideMenuCard.astro", void 0);
...
}, "C:/Users/PC/Desktop/MyCodes/Astro/Spotify-Clone/src/components/AsideMenu.astro", void 0);
...
}, "C:/Users/PC/Desktop/MyCodes/Astro/Spotify-Clone/node_modules/.pnpm/astro@4.3.7_typescript@5.3.3/node_modules/astro/components/ViewTransitions.astro", void 0);
...
const CurrentSong = ({ image, title, artists }) => {
  return /* @__PURE__ */ jsxs("div", { className: `flex items-center gap-5 relative overflow-hidden`, children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex flex-col", children: [
      /* @__PURE__ */ jsx("h3", { className: "font-medium text-sm block", children: title }),
...
const VolumeControl = () => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex justify-center gap-x-2 text-white", children: [
    /* @__PURE__ */ jsx("button", { className: "opacity-70 hover:opacity-100 transition", onClick: handleClickVolume, children: volume < 0.1 ? /* @__PURE__ */ jsx(VolumeSilence, {}) : /* @__PURE__ */ jsx(Volume, {}) }),
    /* @__PURE__ */ jsx(
      Slider,
      {
        defaultValue: [100],
...
}, "C:/Users/PC/Desktop/MyCodes/Astro/Spotify-Clone/src/icons/Time.astro", void 0);
...
const $$MusicsTable = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<table class="table-auto text-left min-w-full divide-y divide-gray-500/20"> <thead class=""> <tr class="text-gray-300 text-sm"> <th class="px-4 py-2 font-light">#</th> <th class="px-4 py-2 font-light">Titulo</th> <th class="px-4 py-2 font-light">Album</th> <th class="px-4 py-2 font-light">${renderComponent($$result, "Time", $$Time, {})}</th> </tr> </thead> <tbody> ${songs.map((song, index) => renderTemplate`<tr class="text-gray-300 text-sm font-light hover:bg-white/10 transition duration-300"> <td class="px-4 py-2 rounded-l-lg w-1">${index + 1}</td> <td class="px-4 py-2 flex gap-3"> <picture class=""> <img${addAttribute(song.image, "src")}${addAttribute(song.title, "alt")} class="w-11 h-11"> </picture> <div class="flex flex-col"> <h3 class="text-white text-base font-normal">${song.title}</h3> <span>${song.artists.join(", ")}</span> </div> </td> <td class="px-4 py-2">${song.album}</td> <td class="px-4 py-2 rounded-r-lg">${song.duration}</td> </tr>`)} </tbody> </table>`;
}, "C:/Users/PC/Desktop/MyCodes/Astro/Spotify-Clone/src/components/MusicsTable.astro", void 0);
...
function CardPlayButton({ id, size = "small" }) {
  ...
  return /* @__PURE__ */ jsx("button", { onClick: handleClick, className: "card-play-button rounded-full bg-green-500 p-4 \r\n        hover:scale-105 transition hover:bg-green-400", children: isPlayingPlaylist ? /* @__PURE__ */ jsx(Pause, { className: iconClassName }) : /* @__PURE__ */ jsx(Play, { className: iconClassName }) });
}
...
const $$id = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Spotify Clone " }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div id="playlist-container" class="relative flex flex-col h-full bg-zinc-900 overflow-x-hidden"${addAttribute(renderTransition($$result2, "lwbbxtwc", "", `playlist ${id} box`), "data-astro-transition-scope")}> <header class="flex flex-row gap-8 px-6 mt-12"> <picture class="aspect-square w-52 h-52 flex-none"> <img${addAttribute(playlist?.cover, "src")}${addAttribute(`Cover of the playlist ${playlist?.title}`, "alt")} class="object-cover w-full h-full shadow-lg"${addAttribute(renderTransition($$result2, "447rgqct", "", `playlist ${playlist?.id} image`), "data-astro-transition-scope")}> </picture> <div class="flex flex-col justify-between"> <h2 class="flex flex-1 items-end">Playlist</h2> <div> <h1 class="text-5xl font-bold block text-white"> ${playlist?.title} <span${addAttribute(renderTransition($$result2, "xqvi2465", "", `playlist ${playlist?.id} title`), "data-astro-transition-scope")}></span> </h1> </div> <div class="flex-1 flex items-end"> <div class="text-sm text-gray-300 font-normal"> <div${addAttribute(renderTransition($$result2, "5hvgcehm", "", `playlist ${playlist?.id} artists`), "data-astro-transition-scope")}> <span>${playlist?.artists.join(", ")}</span> </div> <p class="mt-1"> <span class="text-white">${playlistSongs.length}</span>,
                      3 h aproximadamente
</p> </div> </div> </div> </header> <div class="pl-6 pt-6"> ${renderComponent($$result2, "CardPlayButton", CardPlayButton, { "id": id, "client:load": true, "size": "large", "client:component-hydration": "load", "client:component-path": "@/components/CardPlayButton", "client:component-export": "CardPlayButton" })} </div> <div class="relative z-10 px-6 pt-10"></div> <div class="absolute inset-0 bg-gradient-to-t from-zinc-900 via-zinc-900/80 -z-10"></div> <section class="p-6"> ${renderComponent($$result2, "MusicsTable", $$MusicsTable, { "songs": playlistSongs })} </section> </div> ` })}`;
}, "C:/Users/PC/Desktop/MyCodes/Astro/Spotify-Clone/src/pages/playlist/[id].astro", "self");

const $$file = "C:/Users/PC/Desktop/MyCodes/Astro/Spotify-Clone/src/pages/playlist/[id].astro";
